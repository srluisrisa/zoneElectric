...
<html lang="en">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                <ul>
                  <li><a href="index2.php"><span class="icon icon-person"></span></a></li>
                  <li>
  ...
  <div class="cont">
    <form action="validar.php" method="post">
      ...
      <font color="red">
      <h2>Error al iniciar sesion. Intenta de nuevo</h2></font>
      <label>
      ...
      <p class="forgot-pass">Olvidasto contraseña?</p>
      <button class="submit" value="Ingresar">Iniciar sesion</button>
      <button class="submit" type="button">Registrarme</button>
    </form>
  </div>
